...
<html>
    <head>
        <link rel="icon" href="${pageContext.request.contextPath}/images/football-field.png" type="image/x-icon">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>VUA SÂN CỎ</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container">
            <img src="${pageContext.request.contextPath}/images/football.png" width="50px" height="50px" style="margin-right: 5px"/>
            <c:if test="${user == null || user.roleID == 'US'}">
                <a class="navbar-brand fw-bold fs-3" href="${pageContext.request.contextPath}/home/index.do">VUA SÂN CỎ</a>
            </c:if>
            <c:if test="${user.roleID == 'OW'}">
                <a class="navbar-brand fw-bold fs-3" href="${pageContext.request.contextPath}/owner/index.do">VUA SÂN CỎ</a>
            </c:if>
            <c:if test="${user.roleID == 'AD'}">
                <a class="navbar-brand fw-bold fs-3" href="${pageContext.request.contextPath}/admin/index.do">VUA SÂN CỎ</a>
            </c:if>
